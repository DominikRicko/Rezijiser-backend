...
@Service
public final class NotificationFilteringServiceImpl implements NotificationFilteringService {
    
    protected ZonedDateTimeConverter dateParser;

    public NotificationFilteringServiceImpl(ZonedDateTimeConverter dateParser){
    ...
    private BooleanExpression processRegexFilter(TargetColumn column, String regex) {
        switch (column) {
            case TITLE: 
